...
def greedy_2_regret_weighted_objective_variation_solve(tsp: TSP, starting_node: int = None) -> SolutionTSP:
...
if __name__ == "__main__":
    ...
    t0 = time()
    solution = greedy_2_regret_weighted_objective_variation_solve(tsp, starting_node=0)
    t1 = time()
